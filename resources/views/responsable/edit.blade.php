...
<div class="container">
    <div class="card">
        <div class="card-body">
          <p class="card-text"> Responsable : {{ $responsables->nom}} {{$responsables->prenom}}</p>
        </div>
      </div>
    
<form action="{{route('responsable.update',$responsables->id)}}" method="POST" enctype="multipart/form-data">
...
<div class="mb-3">
  ...
  <input type="text" class="form-control" name="nom" value="{{$responsables->nom}}" id="formGroupExampleInput" placeholder="">
</div>
<div class="mb-3">
  <label for="formGroupExampleInput2" class="form-label">Prénom</label>
  <input type="text" class="form-control" name="prenom" value="{{$responsables->prenom}}" id="formGroupExampleInput2" placeholder="">
</div>
<div  class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input type="email" class="form-control"name="email" value="{{$responsables->email}}" id="exampleInputEmail1" aria-describedby="emailHelp"> 
  </div>
...
<div class="mb-3">
  ...
  <input type="text" class="form-control" name="telephone" value="{{$responsables->telephone}}" id="formGroupExampleInput2" placeholder="">
</div>
  ...
  <a class="btn btn-info " target="__blank" style="align: center;" href="{{ route('responsable.index')}}">Retour</a>
</form>
</div>
